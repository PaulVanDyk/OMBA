...
@api_view(['GET', 'POST'])
@permission_required('OMBA.add_user', raise_exception=True)
...
@permission_required('OMBA.change_user', raise_exception=True)
def user_detail(request, id, format=None):
    ...
    if request.method == 'GET':
        ...
        if not request.user.has_perm('OMBA.delete_user'):
