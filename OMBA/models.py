...
"""
为节省开发时间，参考自：https://raw.githubusercontent.com/welliamcao/OpsManage/master/OpsManage/models.py
"""
...
class Assets(models.Model):
    ...
    buy_user = models.SmallIntegerField(
        blank=True,
        null=True,
        verbose_name='购买人'
    )
    ...
    put_zone = models.SmallIntegerField(
        blank=True,
        null=True,
        verbose_name='放置区域'
    )
    ...
    business = models.SmallIntegerField(
        blank=True,
        null=True,
        verbose_name='业务类型'
    )
...
class Server_Assets(models.Model): 
    ...
    keyfile = models.SmallIntegerField(
        blank=True,
        null=True
    )
    # FileField(
    #     upload_to='./upload/key/',
    #     blank=True,
    #     null=True,
    #     verbose_name='密钥文件'
    # )
    ...
    cpu_number = models.SmallIntegerField(
        blank=True,
        null=True
    )
    vcpu_number = models.SmallIntegerField(
        blank=True,
        null=True
    )
    ...
    selinux = models.CharField(
        max_length=100,
        blank=True,
        null=True
    )
    swap = models.CharField(
        max_length=100,
        blank=True,
        null=True
    )
    raid = models.SmallIntegerField(
        blank=True,
        null=True
    )
...
class Network_Assets(models.Model):
    ...
    configure_detail = models.TextField(
        max_length=100,
        blank=True,
        null=True,
        verbose_name='配置说明'
...
class Disk_Assets(models.Model):      
    ...
    device_volume = models.CharField(
        max_length=100,
        blank=True,
        null=True,
        verbose_name='硬盘容量'
    ...
    device_slot = models.SmallIntegerField(
        blank=True,
        null=True,
        verbose_name='硬盘插槽'
    )
...
class NetworkCard_Assets(models.Model):
    ...
    class Meta:
        db_table = 'omba_networkcard_assets'
...
class Log_Assets(models.Model): 
    assets_id = models.IntegerField(
        verbose_name='资产类型id',
        blank=True,
        null=True,
        default=None
    )
    assets_user = models.CharField(
        max_length=50,
        verbose_name='操作用户',
        default=None
    )
    assets_content = models.CharField(
        max_length=100,
        verbose_name='名称',
        default=None
    )
...
class Project_Config(models.Model):  
    ...
    project = models.ForeignKey(
        'Project_Assets',
        related_name='project_config',
        on_delete=models.CASCADE
    )
    project_env = models.CharField(
        max_length=50,
        verbose_name='项目环境',
        default=None
    )
    project_service = models.SmallIntegerField(
        verbose_name='业务类型'
    )
    project_local_command = models.TextField(
        blank=True,
        null=True,
        verbose_name='部署服务器要执行的命令',
        default=None
    )
    project_repo_dir = models.CharField(
        max_length=100,
        verbose_name='本地仓库目录',
        default=None
    )
    ...
    project_exclude = models.TextField(
        blank=True,
        null=True,
        verbose_name='排除文件',
        default=None
    ...
    project_uuid = models.CharField(
        max_length=50,
        verbose_name='唯一id'
    )
    project_repo_user = models.CharField(
        max_length=50,
        verbose_name='仓库用户名',
        blank=True,
        null=True
    )
    project_repo_passwd = models.CharField(
        max_length=50,
        verbose_name='仓库密码',
        blank=True,
        null=True
    )
    project_repertory = models.CharField(
        choices=project_repertory_choices,
        max_length=10,
        verbose_name='仓库类型',
        default=None
    )
    ...
    project_remote_command = models.TextField(
        blank=True,
        null=True,
        verbose_name='部署之后执行的命令',
        default=None
    )
    project_user = models.CharField(
        max_length=50,
        verbose_name='项目文件宿主',
        default=None
    )
    project_model = models.CharField(
        choices=deploy_model_choices,
        max_length=10,
        verbose_name='上线类型',
        default=None
    )
    project_audit_group = models.SmallIntegerField(
        verbose_name='项目授权组',
        blank=True,
        null=True,
        default=None
...
class Log_Project_Config(models.Model):
    ...
    class Meta:
        db_table = 'omba_log_project_config'
        verbose_name = '项目配置操作记录表'  
        verbose_name_plural = '项目配置操作记录表'                
...
class Project_Order(models.Model):  
    ...
    order_user = models.CharField(
        max_length=30,
        verbose_name='工单申请人'
    )
    order_project = models.ForeignKey(
        'Project_Config',
        verbose_name='项目id'
    )
    order_subject = models.CharField(
        max_length=200,
        verbose_name='工单申请主题'
    )
    ...
    order_branch = models.CharField(
        max_length=50,
        blank=True,
        null=True,
        verbose_name='分支版本'
    )
    order_comid = models.CharField(
        max_length=100,
        blank=True,
        null=True,
        verbose_name='版本id'
    )
    order_tag = models.CharField(
        max_length=50,
        blank=True,
        null=True,
        verbose_name='标签'
    )
    order_audit = models.CharField(
        max_length=30,
        verbose_name='部署指派人'
    )
    ...
    modify_time = models.DateTimeField(
        auto_now=True,
        blank=True,
        verbose_name='工单最后修改时间'
    )

    '''自定义权限'''
    class Meta:
        db_table = 'omba_project_order'
        permissions = (
...
class Cron_Config(models.Model): 
    ...
    cron_day = models.CharField(
        max_length=10,
        verbose_name='天',
        default=None
    )
    cron_week = models.CharField(
        max_length=10,
        verbose_name='周',
        default=None
    )
    ...
    cron_name = models.CharField(
        max_length=100,
        verbose_name='任务名称',
        default=None
    )
    cron_desc = models.CharField(
        max_length=200,
        blank=True,
        null=True,
        verbose_name='任务描述',
    ...
    cron_script_path = models.CharField(
        max_length=100,
        blank=True,
        null=True,
        verbose_name='脚本路径',
    ...
    cron_status = models.SmallIntegerField(
        verbose_name='任务状态',
        default=None
    )

    class Meta:
        db_table = 'omba_cron_config'
        permissions = (
...
class Log_Cron_Config(models.Model): 
    ...
    cron_content = models.CharField(
        max_length=100,
        default=None
    )
    cron_server = models.CharField(
        max_length=100,
        default=None
    )
    create_time = models.DateTimeField(
...
class Log_Ansible_Model(models.Model):
    ...
    ans_model = models.CharField(
        max_length=100,
        verbose_name='模块名称',
        default=None
    )
    ans_args = models.CharField(
        max_length=500,
        blank=True,
        null=True,
        verbose_name='模块参数',
    ...
    class Meta:
        db_table = 'omba_log_ansible_model'
        permissions = (
...
class Ansible_Playbook(models.Model): 
    ...
    playbook_name = models.CharField(
        max_length=50,
        verbose_name='剧本名称',
        unique=True
    )
    playbook_desc = models.CharField(
        max_length=200,
        verbose_name='功能描述',
        blank=True,
        null=True
    )
    playbook_vars = models.TextField(
        verbose_name='模块参数',
        blank=True,
        null=True
    )
    playbook_uuid = models.CharField(
        max_length=50,
        verbose_name='唯一id'
    )
    playbook_server_model = models.CharField(
        choices=type,
        verbose_name='服务器选择类型',
        max_length=10,
        blank=True,
        null=True
    )
    playbook_server_value = models.SmallIntegerField(
        verbose_name='服务器选择类型值',
        blank=True,
        null=True
    )
    ...
    playbook_auth_user = models.SmallIntegerField(
        verbose_name='授权用户',
        blank=True,
        null=True
    )
    playbook_type = models.SmallIntegerField(
        verbose_name='剧本类型',
        blank=True,
        null=True,
        default=0
    ...
    class Meta:
        db_table = 'omba_ansible_playbook'
        permissions = (
...
class Ansible_Script(models.Model): 
    ...
    script_uuid = models.CharField(
        max_length=50,
        verbose_name='唯一id'
    )
    script_server = models.TextField(
        max_length=200,
        verbose_name='目标机器',
        blank=True,
        null=True
    ...
    script_group = models.SmallIntegerField(
        verbose_name='授权组',
        blank=True,
        null=True
    )
...
class Ansible_Playbook_Number(models.Model):
    playbook = models.ForeignKey(
        'Ansible_Playbook',
        related_name='server_number',
        on_delete=models.CASCADE
    )
    playbook_server = models.CharField(
        max_length=100,
        verbose_name='目标服务器',
        blank=True,
        null=True
    ...
    class Meta:
        db_table = 'omba_ansible_playbook_number'
        permissions = (
...
class Global_Config(models.Model):
    ansible_model = models.SmallIntegerField(
        verbose_name='是否开启ansible模块操作记录',
        blank=True,
        null=True
    )
    ansible_playbook = models.SmallIntegerField(
        verbose_name='是否开启ansible剧本操作记录',
        blank=True,
        null=True
    )
    cron = models.SmallIntegerField(
        verbose_name='是否开启计划任务操作记录',
        blank=True,
        null=True
    )
    project = models.SmallIntegerField(
        verbose_name='是否开启项目操作记录',
        blank=True,
        null=True
    )
    assets = models.SmallIntegerField(
        verbose_name='是否开启资产操作记录',
        blank=True,
        null=True
    )
    server = models.SmallIntegerField(
        verbose_name='是否开启服务器命令记录',
        blank=True,
        null=True
    )
    email = models.SmallIntegerField(
        verbose_name='是否开启邮件通知',
        blank=True,
        null=True
    )
    webssh = models.SmallIntegerField(
        verbose_name='是否开启WebSSH',
        blank=True,
        null=True
    )

    class Meta:
        db_table = 'omba_global_config'
...
class Email_Config(models.Model):
    ...
    subject = models.CharField(
        max_length=100,
        verbose_name='发送邮件主题标识',
        default=u'[OPS]'
    )
    cc_user = models.TextField(
        verbose_name='抄送用户列表',
        blank=True,
        null=True
    )
...
class Server_Command_Record(models.Model): 
    ...
    class Meta:
        db_table = 'omba_server_command_record'
        permissions = (
